 ...
 */
function eventbuttonlabel_civicrm_xmlMenu(&$files) {
  _eventbuttonlabel_civix_civicrm_xmlMenu($files);
}
 ...
 */
function eventbuttonlabel_civicrm_postInstall() {
  _eventbuttonlabel_civix_civicrm_postInstall();
}
 ...
 */
function eventbuttonlabel_civicrm_uninstall() {
  _eventbuttonlabel_civix_civicrm_uninstall();
}
 ...
 */
function eventbuttonlabel_civicrm_disable() {
  _eventbuttonlabel_civix_civicrm_disable();
}
 ...
 */
function eventbuttonlabel_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  return _eventbuttonlabel_civix_civicrm_upgrade($op, $queue);
}
 ...
 */
function eventbuttonlabel_civicrm_caseTypes(&$caseTypes) {
  _eventbuttonlabel_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function eventbuttonlabel_civicrm_angularModules(&$angularModules) {
  _eventbuttonlabel_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function eventbuttonlabel_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
  _eventbuttonlabel_civix_civicrm_alterSettingsFolders($metaDataFolders);
}
 ...
 */
function eventbuttonlabel_civicrm_entityTypes(&$entityTypes) {
  _eventbuttonlabel_civix_civicrm_entityTypes($entityTypes);
}

/**
 * Implements hook_civicrm_thems().
 */
function eventbuttonlabel_civicrm_themes(&$themes) {
  _eventbuttonlabel_civix_civicrm_themes($themes);
}
...
function eventbuttonlabel_civicrm_managed(&$entities) {
  _eventbuttonlabel_civix_civicrm_managed($entities);
  $entities[] = [
